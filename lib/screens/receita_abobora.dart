...
class ReceitaAboboraScreen extends StatefulWidget {
  ...
  @override
  State<ReceitaAboboraScreen> createState() => _ReceitaAboboraScreenState();
}
  ...
  void _calcular() {
    ...
    if (peso == null || peso <= 0) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Digite um peso válido para a abóbora.'),
        ),
      );
      return;
    }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              const _InfoCard(
                title: 'Antes de pesar a abóbora',
                icon: Icons.info_outline,
                children: [
                  'Descasque a abóbora e retire as sementes, fiapos e partes muito duras.',
                  'Corte a abóbora em pedaços pequenos.',
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        decoration: const InputDecoration(
                          labelText: 'Peso da polpa de abóbora (g)',
                          hintText: 'Ex: 1000',
              ...
              const SizedBox(height: 16),
              if (_pesoAbobora != null && _acucar != null && _coco != null)
                _IngredientsCard(
                  pesoAbobora: _pesoAbobora!,
                  acucar: _acucar!,
                  coco: _coco!,
                  formatarGramas: _formatarGramas,
                ),
              if (_pesoAbobora != null) const SizedBox(height: 16),
              const _InfoCard(
                title: 'Modo de preparo',
                icon: Icons.menu_book_outlined,
                children: [
                  'Coloque os pedaços de abóbora em uma panela com um copo de água.',
                  'Cozinhe em fogo baixo até que comecem a amolecer.',
                  'Vá mexendo até formar uma consistência mais homogênea.',
              ...
              const _InfoCard(
                ...
                children: [
                  'Não adicione o açúcar enquanto a abóbora ainda estiver em pedaços grandes, pois pode caramelizar.',
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Chimia tradicional de abóbora com coco ralado.',
                  style: TextStyle(
                    fontSize: 14,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _IngredientRow(
              label: 'Abóbora',
              value: formatarGramas(pesoAbobora),
            ),
            _IngredientRow(
              label: 'Açúcar',
            ...
            Container(
              ...
              child: Text(
                'Esses valores foram calculados com base no peso da polpa já preparada.',
                style: TextStyle(
                  color: cs.onSurface,
                  fontSize: 13,
                ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const _NutritionRow(label: 'Calorias', value: '210,4 kcal'),
            const _NutritionRow(label: 'Carboidratos', value: '44,5 g'),
            const _NutritionRow(label: 'Proteínas', value: '0,9 g'),
            const _NutritionRow(label: 'Gorduras totais', value: '3,5 g'),
            const _NutritionRow(label: 'Gorduras saturadas', value: '3,1 g'),
            const _NutritionRow(label: 'Fibra alimentar', value: '1,3 g'),
            ...
            const SizedBox(height: 10),
            const _NutritionRow(label: 'Calorias', value: '10,5 kcal'),
            const _NutritionRow(label: 'Carboidratos', value: '2,2 g'),
            const _NutritionRow(label: 'Proteínas', value: '0,05 g'),
            const _NutritionRow(label: 'Gorduras totais', value: '0,18 g'),
            const _NutritionRow(label: 'Gorduras saturadas', value: '0,15 g'),
            const _NutritionRow(label: 'Fibra alimentar', value: '0,06 g'),
          ],
        ),
      ),
    );
